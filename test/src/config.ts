...
const O = '覆盖物', C = '控件', L = '图层', S = '服务', X = '其他';

// 与 react-bmap test 工程对齐：所有功能页均已复刻
export const PAGES: TestPage[] = [
  ...
  // 其他
  { id: 'context-menu', name: 'ContextMenu', category: X, ready: true },
  { id: 'panorama', name: 'Panorama', category: X, ready: true },
  { id: 'place-detail-panel', name: 'PlaceDetailPanel', category: X, ready: true },
];
