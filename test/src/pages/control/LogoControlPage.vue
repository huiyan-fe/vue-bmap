...
import { LogoControl, BMAP_ANCHOR_BOTTOM_LEFT } from '@baidumap/vue-bmap';
...
const offset = ref<Size | undefined>({ width: 5, height: 15 });
...
<template>
  <ControlPageLayout title="LogoControl" capability="LogoControl" version-note="v4+ 控件，v3 不支持。">
