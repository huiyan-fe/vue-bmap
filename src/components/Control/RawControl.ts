/**
 * RawControl —— useRawControl 的组件糖。对应 react-bmap 的 components/Control/RawControl.tsx。
 *
 * 把任意继承 BMap.Control 的原生实例挂到 Vue 组件树上，库负责 addControl/removeControl。
 ...
 *   :deps="[]"
 *   :on-ready="(inst) => { ctrlRef = inst; }"
 * />
 * ```
 */
import { defineComponent, type PropType } from 'vue';
import { useRawControl } from '../../composables/useRawControl';
...
export const RawControl = defineComponent({
  name: 'RawControl',
  props: {
